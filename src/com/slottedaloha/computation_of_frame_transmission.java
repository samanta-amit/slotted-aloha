...
public class computation_of_frame_transmission {
	...
	//static int []  n = { 2, 2, 2, 2, 2, 2, 2, 2 };
	//static int []  n = { 3, 3, 3, 3, 3, 3, 3, 3 };
	//static int []  n = { 4, 4, 4, 4, 4, 4, 4, 4 };
	//static int []  n = { 5, 5, 5, 5, 5, 5, 5, 5 };
	//static int []  n = { 6, 6, 6, 6, 6, 6, 6, 6 };
	//static int []  n = { 7, 7, 7, 7, 7, 7, 7, 7 };
	...
	public static void compute_farme_transmission () {
		...
		int exp = (int) (Math.random()*3);
		int quo = (int) (Math.random()*9);
		//int exp = (int) (Math.random()*4);
		//int quo = (int) (Math.random()*9);
		double BER = (1+quo)*Math.pow(10, -(5+exp));
		//double BER = (1+quo)*Math.pow(10, -(4+exp));
	    //double BER = Math.pow(10, -5);
	    //double BER = Math.pow(10, -(1+exp));
		System.out.println("\nexp = " + (2+exp));
		System.out.println("\n\nBER = " + BER);
		//double BER = 0.00001;
